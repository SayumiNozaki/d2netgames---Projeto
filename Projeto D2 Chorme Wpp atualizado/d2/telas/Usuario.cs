...
namespace d2
{
    public partial class Usuario : Form
    {
        ...
        private void btnAtt_Click(object sender, EventArgs e)
        {
            if (ValidarCampo() == false)
            {
                var resultado = MessageBox.Show("Você tem certeza que deseja atualizar esse usuário?", "Aviso", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning);
        ...
        private void tbUsuario_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
